...
const AX_PS_COLUMNS = [
  ...
  "[TEMPTANKA2] AS TEMP_A_B",
  "[ADHESIVEHOSEAB1] AS TEMP_HOSE_AB",
  "[COATINGUNITHEAT1] AS TEMP_COATING_FM_BR_WR",
...
// `CASE
//   WHEN [TEMPTANKA1] IS NOT NULL AND [TEMPTANKA1] <> '' AND [TEMPTANKA2] IS NOT NULL AND [TEMPTANKA2] <> '' THEN [TEMPTANKA1] + ', ' + [TEMPTANKA2]
//   WHEN [TEMPTANKA1] IS NOT NULL AND [TEMPTANKA1] <> '' THEN [TEMPTANKA1]
//   WHEN [TEMPTANKA2] IS NOT NULL AND [TEMPTANKA2] <> '' THEN [TEMPTANKA2]
//   ELSE ''
//   END AS `, //[TEMPTANKA1] + ', ' + [TEMPTANKA2] AS TEMP_A_B
