const STANDARD_PARAMETERS = [
  ...
  { key: "SPLICE_SPEED", param_id: 2, name: "Splice Speed", category: "Speed", set_point: "", unit: "m/min", type: "numeric" },
  ...
  { key: "TEMP_COATING_FM_BR_WR", param_id: 10, name: "Coating : Free : Metering and Blade Roller Water Temp", category: "Temperature", set_point: "", unit: "°C", type: "numeric" },
  ...
  { key: "SMOOTHING_ROLL", param_id: 25, name: "Smoothing Roll : % Speed", category: "Status", set_point: "", unit: "ปกติ/ไม่ปกติ", type: "status" },
