const STANDARD_PARAMETERS = [
  ...
  { key: 'TENSION_UNWIND_1', param_id: 10, name: '1st Unwind Tension', set_point: '', unit: 'Kg./N', type: 'numeric' },
  { key: 'TENSION_UNWIND_2', param_id: 11, name: '2nd Unwind Tension', set_point: '', unit: 'Kg./N', type: 'numeric' },
  ...
  { key: 'SMOOTHING_ROLL', param_id: 18, name: 'ชุด Smooting Roll เกลี่ยกาว', set_point: '', unit: 'ปกติ/ไม่ปกติ', type: 'status', options: ['ปกติ', 'ไม่ปกติ'] },
  { key: 'CORONA_INSIDE', param_id: 19, name: 'Corona Treated Inside (ด้านใน)', set_point: '', unit: 'มี/ไม่มี', type: 'status', options: ['มี', 'ไม่มี'] },
  { key: 'CORONA_OUTSIDE', param_id: 20, name: 'Corona Treated Outside (ด้านนอก)', set_point: '', unit: 'มี/ไม่มี', type: 'status', options: ['มี', 'ไม่มี'] },
