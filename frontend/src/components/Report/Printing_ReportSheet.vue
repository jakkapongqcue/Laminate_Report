  ...
  <div class="report-page">
    ...
    <div class="flex items-start justify-between pb-1">
      ...
      <div class="self-center text-center">
        <h1 class="text-base font-bold tracking-wide text-gray-900 uppercase">PRINTING CHECKING REPORT</h1>
      </div>
    ...
    <div class="mb-1 flex flex-wrap items-center gap-x-4 gap-y-1 text-[9px] font-medium">
      ...
      <div class="flex items-center gap-1">
        <span class="font-bold">เครื่องพิมพ์:</span>
    ...
    <div class="flex-1">
      <Printing_ParameterTable :time-columns="pageData.time_columns" :rows="pageData.rows" />
    </div>
    ...
    <div class="pt-2 text-[9px]">
      ...
      <div class="flex items-center">
        <!-- Reviewer -->
        <div class="ml-auto flex w-40 flex-col gap-2">
...
<script setup>
import Printing_ParameterTable from "./Printing_ParameterTable.vue"
