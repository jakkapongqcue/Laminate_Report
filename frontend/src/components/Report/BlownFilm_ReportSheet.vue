  ...
  <div class="report-page">
    ...
    <div class="flex items-start justify-between pb-1">
      ...
      <div class="self-center text-center">
        <h1 class="text-base font-bold tracking-wide text-gray-900 uppercase">BLOWNFILM CHECKING REPORT</h1>
      </div>
    ...
    <div class="mb-1 flex flex-wrap items-center gap-x-4 gap-y-1 text-[9px] font-medium">
      ...
      <div class="flex items-center gap-1">
        <span class="font-bold">เครื่องเป่าฟิล์ม:</span>
    ...
    <div class="flex-1">
      <BlownFilm_ParameterTable :time-columns="pageData.time_columns" :rows="pageData.rows" />
    </div>

    <!-- ── Footer ──────────────────────────────────────────────────────── -->
    <div class="pt-1 text-[8.5px]">
      <!-- Signatures Block -->
      <div class="flex items-center">
        <!-- Reviewer -->
        <div class="ml-auto flex w-40 flex-col gap-1.5">
          <div class="flex items-center gap-2">
            ...
            <span class="block h-3.5 w-full border-b border-gray-400"></span>
          </div>
          <div class="flex items-center gap-2">
            <span class="text-nowrap">วันที่:</span>
            <span class="block h-3.5 w-full border-b border-gray-400 text-center"> </span>
          </div>
        </div>
      </div>
      ...
      <!-- Paper version -->
      <div>
        <span>FM-PRD-XX/XX Rev.XX Effective Date : DD/MM/YYYY</span>
      </div>
    </div>
  </div>
</template>
...
<script setup>
import BlownFilm_ParameterTable from "./BlownFilm_ParameterTable.vue"
